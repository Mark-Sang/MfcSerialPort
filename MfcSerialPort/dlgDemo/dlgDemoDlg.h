...
public:
	...
	static unsigned char Globbuff[1024*768*4];
	static unsigned int Wide;
	static unsigned int Height;
	static unsigned int Widebytes;
	static DWORD Bufflength;
	static BITMAPFILEHEADER bmpHeader; //文件头
...
public:
	afx_msg void OnStnClickedStDisplay();
	afx_msg void OnBnClickedrolate();
};
